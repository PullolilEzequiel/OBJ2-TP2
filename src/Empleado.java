...
public abstract class Empleado {
    ...
    public Empleado(String nombre, Double sueldo_basico, String direccion, GregorianCalendar fecha_nacimiento){
    ...
    public Double getSueldoBruto() { return this.sueldo_basico; }
    ...
    public Double getSueldoNeto(DetallesDeRenumeracion detalle_renumeracion){
        return  this.sueldo_basico + this.getSueldoFamiliar(detalle_renumeracion) - this.getRetencionDeSueldo(detalle_renumeracion);
    }
